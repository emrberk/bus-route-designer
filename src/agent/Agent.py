...
class Agent(threading.Thread):
    ...
    def run(self):
        ...
        while not self._stop_event.is_set():
            ...
            result = self.lib[data['type']][data['instance']]['function'](data['payload'])
            print('result =', result)
